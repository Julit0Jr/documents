...
public class BinaryTree implements Dictionary {
  ...
  public Entry insert(Object key, Object value) {
    ...
    if(root == null)
    	...
    	insertHelper(e, (Comparable)key, root);
    }
    size++;
    return e;
  }
    ...
    if(node == null){//not found
      return null;
        ...
        //if n has two children
          ...
          //use the min method below to find the minimum of the right subtree
          BinaryTreeNode minimum = min(node.rightChild);
